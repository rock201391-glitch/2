  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const noteLines = [
        ...
        buyNowItem ? `شراء مباشر من المزاد: ${buyNowItem.auction_id}` : '',
      ].filter(Boolean);
        ...
        if (buyNowItem) {
          const { error: auctionUpdateError } = await supabase
            ...
            .update({
              ...
              admin_notes: `تم الشراء المباشر - رقم الطلب: ${insertedOrder.id}`,
          ...
          if (auctionUpdateError) {
            console.warn(
              'تم إنشاء الطلب ولكن تعذر تحديث حالة المزاد:',
              auctionUpdateError,
            );
          }
        }
