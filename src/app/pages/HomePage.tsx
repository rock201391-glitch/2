...
export default function HomePage({ onNavigate, onProductClick }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F8F7F2]">
      {/* Hero Section */}
      <section className="w-full py-20 px-4 md:py-32 bg-gradient-to-b from-[#F8F7F2] to-[#F1F0E8]">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6" style={{ color: '#0F3A2B' }}>
            نظرتك من فوق
          </h1>
